...
/**
     ...
     */
    public String day_05_1(String userInputFile) throws IOException, InputFormatException, InputDataException {
        ...
        List<Stack<Character>> crateStacks = initializeStacks(input, blankIndex);

        processInstructions(input, blankIndex, crateStacks);

        return getResult(crateStacks);
    }

    /**
     * Initializes the crateStacks based on the input.
     *
     * @param input      List of input lines
     * @param blankIndex Index of the blank line in the input
     * @return List of initialized crateStacks
     * @throws InputFormatException If there is a format issue with the input
     */
	private List<Stack<Character>> initializeStacks(List<String> input, int blankIndex) throws InputFormatException, InputDataException {
    ...
    /**
     * Processes the instructions and moves crates between crateStacks.
     *
     * @param input      List of input lines
     * @param blankIndex Index of the blank line in the input
     * @param stacks     List of crateStacks representing crates
     * @throws InputFormatException If there is a format issue with the input
     * @throws InputDataException   If there is an issue with the input data
     */
